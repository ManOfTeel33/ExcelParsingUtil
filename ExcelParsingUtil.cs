...
{
    public static class ExcelParsingUtil
    {
        ...
        private static IList<T> GetDataToList<T>(SpreadsheetDocument document, string sheetName, Func<IList<string>, IList<string>, int, T> addData, bool hasHeaders = true)
        {
        ...
        private static IList<string> GetCellValueAsColumnName(SpreadsheetDocument document, Row row)
        {
            return (
                from Cell cell
                in row
        ...
        private static IList<string> GetCellLetters(Row row)
        {
        ...
        private static Row GetRow(WorksheetPart wsPart, int rowNumber)
        {
        ...
        private static IEnumerable<Cell> GetCellsForRow(Row row, IList<string> columnLetters)
        {
            var workIdx = 0;
